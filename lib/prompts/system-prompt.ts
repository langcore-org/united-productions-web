...
const PROGRAMS = [
  {
    ...
    schedule: "毎週火曜 20:55〜",
    cast: "マツコ・デラックス",
    description: "ゲスト自ら得意ジャンルやハマっているものを企画として持ち込み、マツコ・デラックスとサシトーク",
    startDate: "2011年〜",
  ...
  },
  {
    ...
    description: "飲食店を模したスタジオで、オードリーがゲストとトークを展開。大将（春日）と常連（若林）の設定",
  ...
  },
  {
    ...
    description: "「サビだけカラオケ」などの人気企画で、芸能人が挑戦。1音も外さずに10曲歌えるかなどのゲーム",
  ...
  },
  {
    ...
    notes: "旧タイトル：「〜通販マニアさん」。ニトリマニア、家事マニアなど身近なジャンルのマニアが登場",
  },
  {
    id: "hayashiosamu",
    name: "林修の今、知りたいでしょ！",
    ...
    description: "普段は教える立場の林修先生が生徒に変身。各分野の講師が林修に知らない世界をレクチャー",
  ...
  },
  {
    ...
    description: "「二階堂＋カム（Come）＝ニカゲーム」。ちょっと奇妙な教育番組の世界でひらめきゲームに挑戦",
  ...
  },
  {
    ...
    schedule: "毎週木曜 22:00〜",
    cast: "櫻井翔、有吉弘行",
    description: "櫻井翔と有吉弘行がゲストを招いてトークを展開。プライベートな話題や、ゲストの意外な一面を掘り下げる",
