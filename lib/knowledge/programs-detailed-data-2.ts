...
export const programHayashiosamu: ProgramInfo = {
  ...
  recentEpisodes: [
    {
      broadcastDate: "2026-02-19",
      title: "昭和の常識と令和の新常識 テストで学ぶ「これが今でしょ！」2時間SP",
      content:
        "昭和時代の常識が令和になって変わった内容をテスト形式で学ぶ。けがをしたら傷口は乾燥させる／鼻血が出たら上を向いて首をトントン／突き指したら伸ばす／かぜをひいたらおでこを冷やす…などの昭和の常識が令和ではどう変わったかを検証。",
      guests: ["名取裕子", "千葉雄大", "大澤サラ", "伊集院光"],
    },
    {
      broadcastDate: "2026-01-29",
      title: '最新ゴールド検定SP〜なぜ今"金"がスゴいのか？',
      content:
        "金の価格が記録的に高騰中（1g25000円）という背景を解説。なぜ金は価値があるのか、地球上に存在する総量の衝撃的事実を紹介。売りたい人が急増中の「家にある意外な金」を特集。",
      guests: ["木村多江", "鈴木浩介", "ビビる大木", "宮部のぞみ"],
    },
    {
      broadcastDate: "2026-01-08",
      title: "今こそ食べて欲しい みかんVSりんご 冬に気になる4大症状に…健康パワー対決SP",
      content:
        '冬の定番フルーツであるみかんとりんごの健康パワーを対決形式で検証。りんごは"痩せ菌"を増やし、みかんは内臓脂肪を減らす効果があるという研究結果を紹介。',
      guests: ["佐野勇斗（M!LK）", "伊集院光"],
    },
    {
      broadcastDate: "2025-11-20",
      title: "コーヒーVS紅茶！名医が教える最強の飲み方 2時間SP",
      content:
        '"心臓・血管"、"脳"、"血糖値"という3つの分野でコーヒーと紅茶の体にいいポイントを分析。世界一のバリスタが美味しいコーヒーの淹れ方と、おいしい紅茶の作り方を紹介。',
      guests: ["潮紗理菜", "高橋光臣", "名取裕子", "伊集院光"],
    },
    {
      broadcastDate: "2025-10-16",
      title: "令和のたまごパワー最前線を探れ！『たまご』緊急取調SP 2025",
      content:
        'かつて血中コレステロールを溜めるため"1日1個まで"とされていたたまごが、2018年に番組で検証し"1日に何個食べてもOK"となった経緯を振り返る。あれから7年が経ち、医学・科学の進歩によってさらなる事実が判明。',
      guests: ["天海祐希", "田中哲司", "塚地武雅", "伊集院光"],
    },
  ],
};
  ...
  recentEpisodes: [
    {
      ...
      title: "ジェシーが超神業！「スカイダイビングでルービックキューブ」新春スペシャル",
      content:
        "「神業アーチェリー」SixTONES・ジェシーがアーチェリーで超難関ミッションに挑戦。「スカイダイビングでルービックキューブ」ジェシーがスカイダイビング中にルービックキューブを完成させるという超神業に挑む。",
      guests: [
        "ジェシー（SixTONES）",
        "池田美優",
        "出川哲朗",
    ...
    },
    {
      ...
      title: "神超えチャレンジ〜くら寿司編＆神業バドミントン",
      content:
        '「神超えチャレンジ〜くら寿司編」なにわ男子・高橋恭平、INI・木村柾哉、FANTASTICS・中島颯太がチームを結成。開発した新メニューで、くら寿司の"商品開発の神"との売り上げ対決に挑む。「神業バドミントン」日本バドミントン界の至宝・桃田賢斗が登場。',
      guests: [
        "高橋恭平（なにわ男子）",
        "木村柾哉（INI）",
        "中島颯太（FANTASTICS）",
    ...
    {
      broadcastDate: "2025-11-11",
      title: "神業アーチェリー＆神業クレーンゲーム",
      content:
        "「神業アーチェリー」SixTONES・ジェシーがアーチェリーの公式大会に出場。これまで同企画で行ってきた距離から20mも遠い距離の的を射抜くという大会ルールの下、奮闘する。「神業クレーンゲーム」鈴木福＆楽兄弟、カジサック一家が超難関クレーンに挑む。",
      guests: [
        "ジェシー（SixTONES）",
        "梶原雄太",
        "梶原叶渚",
    ...
    },
    {
      ...
      title: "目隠し太鼓の達人〜最強の敵「紅」に四天王が挑む！！",
      content:
        "番組の目玉企画「神業目隠し太鼓の達人」で最強おにモードのX JAPAN「紅」に四天王が挑む。画面を隠した状態で難易度「おに」の「紅」をミスなくフルコンボで叩き切るという超難関ミッション。",
      guests: [
        "パーマ大佐",
        "高野洸",
        "河野玄斗",
    ...
    {
      broadcastDate: "2025-10-21",
      title: "超人アスリートVS超神業＆神業覆面シンガー",
      content:
        "「超人アスリートVS超神業」パリ五輪で銅メダルを獲得したフェンシングの江村美咲選手、福島史帆実選手が登場。空から舞う紙を一突きできるかといった超難関に挑む。「神業覆面シンガー」松浦航大とチョコレートプラネット・長田庄平が、神奈川・藤沢駅を舞台に歌声だけで観客100人を集められるか挑戦。",
      guests: [
        "江村美咲（フェンシング）",
        "福島史帆実（フェンシング）",
        "松浦航大",
  ...
  recentEpisodes: [
    {
      ...
      title: "折り紙デスゲーム第2弾",
      content:
        "1月に放送し大反響を呼んだ「音楽にのせて折り紙の折り方を伝えろ」の第2弾。出題者1人が音楽にのって言葉だけで折り紙の折り方を説明。残りの解答者2名が、その歌を聞いて正しく折り紙が折れたらゲームクリア。",
      guests: ["和田まんじゅう（ネルソンズ）"],
    },
    {
      broadcastDate: "2026-02-18",
      title: "折り紙デスゲーム誕生",
      content:
        "新企画「音楽にのせて折り紙の折り方を伝えろ」が初登場。音楽に合わせて折り紙の折り方を歌で説明し、相手に正しく折らせるというゲーム。二階堂が激怒し、ケムリが絶望、猪俣が大混乱に陥る波乱の展開。",
      guests: ["サンシャイン池崎"],
    },
    {
      broadcastDate: "2026-02-11",
      title: "四字熟語トーナメントwith松倉海斗",
      content:
        "新企画「四字熟語トーナメント」を開催。ルールは二階堂・猪俣がお題の四字熟語を一文字ずつ戦わせ、トーナメント表を作成。残りの解答者がどの漢字が勝つかを予想する。Travis Japanの松倉海斗が「にぃに」と慕う二階堂の思考を読み解くべく参戦。",
      guests: ["松倉海斗（Travis Japan）", "サンシャイン池崎"],
    },
    {
      broadcastDate: "2026-02-04",
      title: "四字熟語トーナメント",
      content:
        "「四字熟語トーナメント」開催。二階堂・猪俣がお題の四字熟語を一文字ずつ戦わせ、トーナメント形式で勝敗を決める。ケムリと松倉が二階堂・猪俣の思考回路を読み取るべく奮闘。",
      guests: ["松倉海斗（Travis Japan）"],
    },
    {
      broadcastDate: "2026-01-28",
      title: "四漢字会話",
      content:
        "新企画「四漢字会話」を放送。二階堂と猪俣の2人が与えられたトークテーマに沿って会話を進行。しかし発言できるのは漢字4文字のみ。ケムリと田渕が二階堂・猪俣の思考回路を読み取り、トークテーマを早押しで予想する。",
      guests: ["田渕章裕（ちょんまげラーメン）"],
    },
  ],
};
  ...
  recentEpisodes: [
    {
      ...
      title: "ともしげ軍団爆誕！",
      content:
        "ともしげが大好きな美女も登場。三四郎小宮、赤嶺総理、パンプキンポテトフライ、カナメストーンらが集結した特別企画。",
      guests: ["三四郎小宮", "赤嶺総理", "パンプキンポテトフライ", "カナメストーン"],
    },
    {
      broadcastDate: "2026-02-23",
      title: "目黒蓮大喜利",
      content: "人気アイドルSnow Manの目黒蓮に関連するお題や、日常の出来事を大喜利形式で回答。",
      guests: [
        "バッファロー吾郎A",
        "R藤本",
        "ニッポンの社長辻",
    ...
    {
      broadcastDate: "2026-02-20",
      title: "陽キャ大喜利",
      content: "陽気なキャラクターたちが集まり、陽キャ視点での大喜利を披露。",
      guests: ["クロちゃん", "四千頭身後藤", "信子"],
    },
    {
      broadcastDate: "2026-02-19",
      title: "Z世代による大喜利まつり",
      content: "Z世代芸人による新鮮な視点の大喜利を披露。",
      guests: ["にぼしいわし", "ナユタ", "サンタモニカ"],
    },
    {
      broadcastDate: "2026-02-18",
      title: "ともしげ大喜利勉強会第5弾",
      content: "伝書鳩、ガクヅケらがともしげの大喜利勉強会に参加。",
      guests: ["伝書鳩", "ガクヅケ", "モンスターエンジン西森洋一", "ギャロップ林健"],
    },
  ],
};
  ...
  recentEpisodes: [
    {
      broadcastDate: "2026-02-24",
      title: "川崎の闇",
      content: "川崎出身または川崎にゆかりのある芸人たちが49秒のショートネタで競演。",
      guests: ["スクールゾーン", "いわたまあり", "元祖いちごちゃん", "青色1号"],
    },
    {
      broadcastDate: "2026-02-23",
      title: "究極のひとボケ",
      content: "実力派芸人たちが1つのボケ（笑いのツボ）を極めたネタを披露。",
      guests: ["ニッポンの社長", "ゆにばーす", "中山功太", "ななまがり"],
    },
    {
      broadcastDate: "2026-02-20",
      title: "モーニング娘。ネタSP",
      content:
        "アイドルグループ「モーニング娘。」に関連するネタや、モー娘。メンバーが審査員として参加。",
      guests: ["モーニング娘。メンバー（前田こころなど）", "新進気鋭の若手芸人"],
    },
    {
      broadcastDate: "2026-02-19",
      title: "ふかわりょうの最新ネタ",
      content:
        "ふかわりょうの最新ネタが話題に。TikTokでバズり、アップロードからわずか2日間で視聴回数250万回を突破した人気回。",
      guests: ["ふかわりょう", "きつね", "淡路"],
    },
    {
      broadcastDate: "2026-02-18",
      title: "鳥肌オチSP",
      content: "ホラー・サスペンス要素を含んだ鳥肌が立つようなオチのネタを披露。",
      guests: ["中山功太", "ファイヤーサンダー", "たかみち店長"],
    },
  ],
};
...
export const programHenaimuseum: ProgramInfo = {
  ...
  recentEpisodes: [
    {
      broadcastDate: "2026-02-28",
      title: "かたつむりミュージアム・プロレス美術館",
      content:
        "京都・木津川にある「かたつむりミュージアム・ラセン館」（2019年開館）を訪問。日本を中心に世界のカタツムリの標本を約900種展示している博物館。伊集院が館長とカタツムリの生態や魅力について語り合う。",
      guests: ["伊集院光（単独MC）"],
    },
    {
      broadcastDate: "2026-01-31",
      title: "ボトルシアター・郷愁のふるさと館",
      content:
        "瓶の中にミニチュア世界を作り込む芸術作品を展示する博物館と、日本の原風景や郷愁を感じさせる展示物を収蔵する博物館を訪問。",
      guests: ["伊集院光（単独MC）"],
    },
    {
      broadcastDate: "2025-11-22",
      title: "古代エジプト美術館・テルミンミュージアム",
      content:
        "古代エジプトの美術品や資料を展示する博物館と、世界初の電子楽器であるテルミンに特化した博物館を訪問。",
      guests: ["伊集院光（単独MC）"],
    },
    {
      broadcastDate: "2025-10-25",
      title: "日本万華鏡博物館・アメリカンクラシックルアー博物館",
      content:
        "館長が30年以上にわたって収集した万華鏡を展示する博物館と、アメリカ製のクラシックな釣り具の歴史を紹介する博物館を訪問。",
      guests: ["伊集院光（単独MC）"],
    },
    {
      broadcastDate: "2025-08-26",
      title: "宮川香山眞葛ミュージアム・金庫と鍵の博物館",
      content:
        "明治時代の陶芸家・宮川香山の作品を展示する博物館と、世界中の珍しい金庫と鍵を収蔵する博物館を訪問。親子三代の歴史が詰まった激レア金庫が登場し、伊集院が鍵開けに苦戦。",
      guests: ["伊集院光（単独MC）"],
    },
  ],
};
