        ...
        <div className="flex-none border-t border-gray-200 bg-gray-50 px-4 py-2">
          <div className="max-w-3xl mx-auto flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-red-600 bg-white border border-gray-200 rounded-lg hover:bg-red-50 transition-colors"
            >
