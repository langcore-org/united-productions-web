...
const NEW_CHAT_BUTTONS = [
  ...
  },
  {
    ...
    label: "出演者リサーチ",
    href: "/chat?gem=research-cast&new=1",
    description: "出演者候補を調査",
  },
  {
    icon: <MapPin className="w-[18px] h-[18px]" />,
    label: "場所リサーチ",
    href: "/chat?gem=research-location&new=1",
    description: "ロケ地を調査",
  },
  {
    icon: <Info className="w-[18px] h-[18px]" />,
    label: "情報リサーチ",
    href: "/chat?gem=research-info&new=1",
    description: "情報を収集",
  },
  {
    icon: <Shield className="w-[18px] h-[18px]" />,
    label: "エビデンスリサーチ",
    href: "/chat?gem=research-evidence&new=1",
    description: "事実確認を実施",
  },
  {
    icon: <FileText className="w-[18px] h-[18px]" />,
    label: "議事録作成",
    href: "/chat?gem=minutes&new=1",
    description: "議事録を作成",
  },
  {
    icon: <Lightbulb className="w-[18px] h-[18px]" />,
    label: "新企画立案",
    href: "/chat?gem=proposal&new=1",
    description: "企画提案を作成",
  },
  {
    icon: <Mic className="w-[18px] h-[18px]" />,
    label: "NA原稿作成",
    href: "/chat?gem=na-script&new=1",
    description: "NA原稿を作成",
  },
];
