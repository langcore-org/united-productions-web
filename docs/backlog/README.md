...
| ファイル | 種別 | 優先度 | 状態 | 概要 |
|---------|------|-------|------|------|
| [research/youtube-instagram-research-integration.md](./research/youtube-instagram-research-integration.md) | 機能追加 | 🟡 中 | 第2段階待ち | YouTube/Instagramリサーチ統合（費用対効果検討後） |
| [research/sns-paid-tool-verification.md](./research/sns-paid-tool-verification.md) | 技術調査 | ✅ 完了 | 検証済み | SNS有料ツール統合検証（第2段階に延期） |
...
| [langchain-future-considerations.md](./langchain-future-considerations.md) | 技術選定 | 🟢 低 | 将来検討 | LangChain将来拡張用（Gemini追加時） |
...
- [Backlog README](./README.md) - Backlog管理ガイド（本ファイル）
- [specs/](../specs/) - 技術仕様書
