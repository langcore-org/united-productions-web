...
調査結果: [`docs/specs/api-integration/xai-citations-behavior-spec.md`](../specs/api-integration/xai-citations-behavior-spec.md)
...
- [xAI Citations 詳細調査](../specs/api-integration/xai-citations-behavior-spec.md) - 15パターンの検証結果
